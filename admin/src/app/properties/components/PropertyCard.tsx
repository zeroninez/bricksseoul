...
export const PropertyCard = (property: PropertyListItem & { key: string }) => {
  return (
    <Link
      ...
      scroll={true}
      className='w-full h-fit text-left flex flex-col gap-3.5 relative bg-stone-200 text-black rounded-xl p-3'
    >
      {/* 이미지 슬라이더 */}
      <Swiper
        pagination={{
      ...
      <div className='flex flex-col gap-1.5 px-1'>
        <div className='text-lg leading-tight font-bold text-black'>{property.name}</div>
